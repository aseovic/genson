package com.owlike.genson.ext.common;
...
public abstract class BaseAnnotationTest {
  ...
  public void testJsonPropertySerializationOnField() {
    final String expected = "{\n" +
        "  \"@class\":\"com.owlike.genson.ext.common.Data$JsonPropertyOnField\",\n" +
        "  \"name\":\"Bilbo\"\n" +
        "}";
  ...
  public void testJsonPropertySerializationOnGetterSetter() {
    final String expected = "{\n" +
        "  \"@class\":\"com.owlike.genson.ext.common.Data$JsonPropertyOnGetterSetter\",\n" +
        "  \"name\":\"Bilbo\"\n" +
        "}";
  ...
  public void testJsonPropertySerializationOnFieldIgnored() {
    final String expected = "{\n" +
        "  \"@class\":\"com.owlike.genson.ext.common.Data$JsonPropertyOnFieldIgnored\"\n" +
        "}";
  ...
  public void testJsonPropertySerializationOnGetterIgnoredSetter() {
    final String expected = "{\n" +
        "  \"@class\":\"com.owlike.genson.ext.common.Data$JsonPropertyOnGetterIgnoredSetter\"\n" +
        "}";
  ...
  public void testJsonPropertySerializationOnGetterSetterIgnored() {
    final String expected = "{\n" +
        "  \"@class\":\"com.owlike.genson.ext.common.Data$JsonPropertyOnGetterSetterIgnored\",\n" +
        "  \"name\":\"Bilbo\"\n" +
        "}";
  ...
  public void testJsonPropertySerializationOnFieldCustomName() {
    final String expected = "{\n" +
        "  \"@class\":\"com.owlike.genson.ext.common.Data$JsonPropertyOnFieldCustomName\",\n" +
        "  \"n\":\"Bilbo\"\n" +
        "}";
  ...
  public void testJsonPropertySerializationOnGetterSetterCustomName() {
    final String expected = "{\n" +
        "  \"@class\":\"com.owlike.genson.ext.common.Data$JsonPropertyOnGetterSetterCustomName\",\n" +
        "  \"n\":\"Bilbo\"\n" +
        "}";
  ...
  public void testJsonCreatorDeserialization() {
    final String input = "{\n" +
        "  \"@class\":\"com.owlike.genson.ext.common.Data$JsonCreatorConstructor\",\n" +
        "  \"name\":\"Bilbo\"\n" +
        "}";
  ...
  public void testJsonCreatorFactoryMethodDeserialization() {
    final String input = "{\n" +
        "  \"@class\":\"com.owlike.genson.ext.common.Data$JsonCreatorFactoryMethod\",\n" +
        "  \"name\":\"Bilbo\"\n" +
        "}";
